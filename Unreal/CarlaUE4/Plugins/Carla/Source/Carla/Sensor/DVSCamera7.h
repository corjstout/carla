...
#include "DVSCamera7.generated.h"


/// Sensor that produce Dynamic Vision Events
UCLASS()
class CARLA_API ADVSCamera7 : public AShaderBasedSensor
{
  GENERATED_BODY()
  using DVSEventArray = std::vector<::carla::sensor::data::DVSEvent>;

public:
  ADVSCamera7(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  ADVSCamera7::DVSEventArray Simulation (float DeltaTime);
