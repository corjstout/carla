...
#include "DVSCamera6.generated.h"


/// Sensor that produce Dynamic Vision Events
UCLASS()
class CARLA_API ADVSCamera6 : public AShaderBasedSensor
{
  GENERATED_BODY()
  using DVSEventArray = std::vector<::carla::sensor::data::DVSEvent>;

public:
  ADVSCamera6(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  ADVSCamera6::DVSEventArray Simulation (float DeltaTime);
