...
#include "DVSCamera9.generated.h"


/// Sensor that produce Dynamic Vision Events
UCLASS()
class CARLA_API ADVSCamera9 : public AShaderBasedSensor
{
  GENERATED_BODY()
  using DVSEventArray = std::vector<::carla::sensor::data::DVSEvent>;

public:
  ADVSCamera9(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  ADVSCamera9::DVSEventArray Simulation (float DeltaTime);
