...
#include "DVSCamera10.generated.h"


/// Sensor that produce Dynamic Vision Events
UCLASS()
class CARLA_API ADVSCamera10 : public AShaderBasedSensor
{
  GENERATED_BODY()
  using DVSEventArray = std::vector<::carla::sensor::data::DVSEvent>;

public:
  ADVSCamera10(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  ADVSCamera10::DVSEventArray Simulation (float DeltaTime);
