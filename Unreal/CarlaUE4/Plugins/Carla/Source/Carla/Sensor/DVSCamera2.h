...
#include "DVSCamera2.generated.h"


/// Sensor that produce Dynamic Vision Events
UCLASS()
class CARLA_API ADVSCamera2 : public AShaderBasedSensor
{
  GENERATED_BODY()
  using DVSEventArray = std::vector<::carla::sensor::data::DVSEvent>;

public:
  ADVSCamera2(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  ADVSCamera2::DVSEventArray Simulation (float DeltaTime);
