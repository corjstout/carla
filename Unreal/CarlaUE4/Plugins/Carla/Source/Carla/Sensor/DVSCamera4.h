...
#include "DVSCamera4.generated.h"


/// Sensor that produce Dynamic Vision Events
UCLASS()
class CARLA_API ADVSCamera4 : public AShaderBasedSensor
{
  GENERATED_BODY()
  using DVSEventArray = std::vector<::carla::sensor::data::DVSEvent>;

public:
  ADVSCamera4(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  ADVSCamera4::DVSEventArray Simulation (float DeltaTime);
