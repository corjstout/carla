...
#include "DVSCamera3.generated.h"


/// Sensor that produce Dynamic Vision Events
UCLASS()
class CARLA_API ADVSCamera3 : public AShaderBasedSensor
{
  GENERATED_BODY()
  using DVSEventArray = std::vector<::carla::sensor::data::DVSEvent>;

public:
  ADVSCamera3(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  ADVSCamera3::DVSEventArray Simulation (float DeltaTime);
