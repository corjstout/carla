...
#include "DVSCamera5.generated.h"


/// Sensor that produce Dynamic Vision Events
UCLASS()
class CARLA_API ADVSCamera5 : public AShaderBasedSensor
{
  GENERATED_BODY()
  using DVSEventArray = std::vector<::carla::sensor::data::DVSEvent>;

public:
  ADVSCamera5(const FObjectInitializer &ObjectInitializer);
...
protected:
  ...
  ADVSCamera5::DVSEventArray Simulation (float DeltaTime);
